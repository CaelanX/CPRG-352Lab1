...
<html>
    ...
    <body>
        ...
        <form action="arithmetic" method="POST">
            ...
            <tr>
                <td><label for="num1">First Number:</label><input type="number" name="num1" value="${num1}"></td>
            </tr>
            <tr><td><label for="num2">Second Number:</label><input type="number" name="num2" value="${num2}"></td></tr>
